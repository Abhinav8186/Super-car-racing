...
function preload() {
  ...
  car4 = loadImage("images/car3.png")
  gameOverImg = loadImage("images/gameOver.png");
  horn = loadSound("sound/car horn.mp3")
  engine = loadSound("sound/race theme hunt.mp3")
...
function setup() {
  ...
  bot2 = new Group();
  bot3 = new Group();
  AI = createSprite(200, 580)
  AI.addImage(car5)
  AI.scale = 0.6
  AI.setCollider("rectangle", 0, 0, 3500, AI.height);
  AI.debug = false
...
function draw() {
  ...
  if (gameState === PLAY) {
    ...
    if (AI.isTouching(bot1)) {
      AI.y = AI.y -10;
    }
    if (AI.isTouching(bot2)) {
      AI.y= AI.y + 10;
    }
    if (AI.isTouching(bot3)) {
      AI.y=AI.y-10;
    }
   /* if(AI.isTouching(wall)){
      AI.y = 380
    }
    if(AI.isTouching(wall1)){
      AI.y = 380
    }
    AI.bounceOff(wall)
    AI.bounceOff(wall1)*/
